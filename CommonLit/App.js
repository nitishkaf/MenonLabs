...
export default App = () => {
  ...
  const getLibrary = async () => {
    try {
      const token =
        '9759826c246d687a67328c4c81811bb108821e41af3c42ce41e6ff28ebf8bbba9737947232dd64e32df99a54a0add95c498001d917ca96258d50444af256a2dc';
  ...
  function BookScreen({navigation}) {
    ...
    const contentWidth = useWindowDimensions().width * 3;
    ...
    return (
      <View>
        <Button title="Load Book" onPress={() => getBook()} />
        {isBookLoading ? (
          <ActivityIndicator />
        ) : (
          <ScrollView>
